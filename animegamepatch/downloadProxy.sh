downloadproxy() {
    ...
    run_Program() {
        wget https://raw.githubusercontent.com/FNStoree/Gengsin/main/proxy.py -q &>$HOME/zerr.log
        errCode=$?
        log "$errCode"
    }
    run_Program &
    ...
    run_Program() {
        wget https://raw.githubusercontent.com/FNStoree/Gengsin/main/proxy_config.py -q &>$HOME/zerr.log
        errCode=$?
        log "$errCode"
    }
    run_Program &
